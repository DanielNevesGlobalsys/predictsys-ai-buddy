...
-- Update rpc_promote_prediction_batch to also set last_heartbeat_at
CREATE OR REPLACE FUNCTION public.rpc_promote_prediction_batch(
  p_project_id uuid,
  p_batch_id text,
  p_model_id uuid DEFAULT NULL,
  p_selection_version integer DEFAULT NULL,
...
BEGIN
  ...
  -- Upsert prediction state (SSOT for dashboard) with last_heartbeat_at
